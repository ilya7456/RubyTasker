...
class AppDelegate
    ...
    #
    # Returns the directory the application uses to store the Core Data store file. This code uses a directory named "RubyTasker" in the user's Library directory.
    #
    def applicationFilesDirectory
        ...
        library_url.URLByAppendingPathComponent("RubyTasker")
    end
    ...
    def managedObjectModel
        unless @managedObjectModel
          model_url = NSBundle.mainBundle.URLForResource("RubyTasker", withExtension:"momd")
    ...
    def persistentStoreCoordinator
        ...
        url = directory.URLByAppendingPathComponent("RubyTasker.storedata")
